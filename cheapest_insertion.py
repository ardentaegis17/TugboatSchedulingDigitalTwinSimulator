...
OUTPUT_FILE = "optimised_schedule_safety.json"
TRAJ_FOLDER = "standardised_trajectories" # Folder containing your CSVs
...
# Ensure these Origin coords match what you use for your Trajectories!
...
def check_trajectory_safety(candidate_job, proposed_start_time, scheduled_jobs):
    ...
    for other_job in scheduled_jobs:
        ...
        # 3. Spatiotemporal Check (The Heavy Lifter)
...
def run_safety_insertion():
    ...
    for job in jobs:
        ...
        while not is_safe:
            if check_trajectory_safety(job, safe_start_time, scheduled_jobs):
                ...
                # In a real efficient implementation, you'd jump to the end of the conflict
                safe_start_time += 60 
    ...
    print(f"Saving optimized schedule to {OUTPUT_FILE}...")
