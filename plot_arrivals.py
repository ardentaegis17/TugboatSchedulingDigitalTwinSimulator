...
# Ensure this matches the filename output from the previous step
df = pd.read_csv("pasir_panjang_arrivals.csv")
...
lambda_t.to_csv("lambda_parameters.csv")
# 5. Plotting
...
# Save the plot
plt.savefig("vessel_arrivals_by_type.png")
plt.show()
