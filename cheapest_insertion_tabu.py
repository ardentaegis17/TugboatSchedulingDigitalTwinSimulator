...
TRAJ_FOLDER = "standardised_trajectories" 
...
def run_tabu_search():
    ...
    print(f"Initial Cost (From Cheap Insertion): {current_cost:.1f}s")

    # 3. Optimization Loop
    for iteration in range(MAX_ITERATIONS):
        
        # A. Generate Neighborhood (Random Swaps)
        candidates = []
        ...
        for _ in range(NEIGHBORHOOD_SIZE):
            ...
            # Identify current tugs vs available tugs
            ...
            # Tabu Check
            # We ban the specific move (Job, TugIn) to prevent cycling
        ...
        if best_candidate:
            ...
            # If no valid candidates found (all tabu or no swaps possible), just continue
            pass
